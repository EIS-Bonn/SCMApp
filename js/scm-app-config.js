...
define(['jquery', 'lib/rdfstore', 'logger', 'lib/vis.min'],
  ...
  var nodes = new vis.DataSet([
    {id: 1, label: 'Iron Mine ZZ', title: 'configured endpoint: http://52.88.118.10:9090/proxy/default/sparql'},
  ...
  var edges = new vis.DataSet([
    {from: 1, to: 8, arrows:'to', label: '82%',font:{color:'red', background:'yellow'}},
    {from: 1, to: 3, arrows:'to', label: '92%',},
    {from: 1, to: 2, arrows:'to', label: '100%',},
    {from: 2, to: 4, arrows:'to', label: '99%',},
    {from: 2, to: 5, arrows:'to', label: '95%',},
    {from: 5, to: 6, arrows:'to', label: '92%',},
    {from: 6, to: 7, arrows:'to', label: '78%',
      font:{color:'red', background:'yellow'}, 
  ...
  {
    var uri = 'http://52.88.118.10:9090/proxy/default/sparql?access_token=869479ea-ea65-4d7d-acb6-2d26398155e5&query=select * from <http://testpage.com> where {?s ?p ?o}';
